...
const byte seg_addr[7]={0x00,0x01,0x02,0x03,0x04,0x05,0x06};//no bit of digital segments
//                       SG0  SG1  SG2  SG3  SG4  SG5  SG6  SG7  DVD  VCD  MP3  PLY  PAU  PBC  RET  DTS  DDD  CL1  CL2   //name   -|
const byte led_addr[1]={0x01};//adress -| for the signs's and disc's leds
const byte led_val[1]= {0x02};//byte   -|
